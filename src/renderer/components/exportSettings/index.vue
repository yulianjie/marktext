  ...
  <div class="print-settings-dialog">
    ...
    >
      ...
      <el-tabs v-model="activeName">
        <el-tab-pane :label="$t('exportSettings.tabs.info')" name="info">
          <span class="text">{{ $t('exportSettings.info.description') }}</span>
        </el-tab-pane>
        <el-tab-pane :label="$t('exportSettings.tabs.page')" name="page">
          <!-- HTML -->
          ...
          <div v-if="isPrintable">
            <div v-if="exportType === 'pdf'">
              ...
              <bool
                :description="$t('exportSettings.page.landscape')"
                :bool="isLandscape"
        ...
        <el-tab-pane :label="$t('exportSettings.tabs.style')" name="style">
          <bool
            :description="$t('exportSettings.style.overwriteFont')"
          ...
          <bool
            :description="$t('exportSettings.style.autoNumberingHeadings')"
            :bool="autoNumberingHeadings"
            :onChange="value => onSelectChange('autoNumberingHeadings', value)"
          ></bool>
          <bool
            :description="$t('exportSettings.style.showFrontMatter')"
            :bool="showFrontMatter"
            :onChange="value => onSelectChange('showFrontMatter', value)"
          ></bool>
        </el-tab-pane>
        <el-tab-pane :label="$t('exportSettings.tabs.theme')" name="theme">
          <div class="text">{{ $t('exportSettings.theme.description') }}</div>
          <cur-select
            :description="$t('exportSettings.theme.label')"
        ...
        <el-tab-pane v-if="isPrintable" :label="$t('exportSettings.tabs.header')" name="header">
          <div class="text">{{ $t('exportSettings.headerFooter.description') }}</div>
          <cur-select
            :description="$t('exportSettings.headerFooter.headerType')"
            :value="headerType"
            :options="localizedHeaderFooterTypes"
            :onChange="value => onSelectChange('headerType', value)"
          ></cur-select>
          <text-box
            v-if="headerType === 2"
            :description="$t('exportSettings.headerFooter.headerLeft')"
          ...
          <text-box
            v-if="headerType !== 0"
            :description="$t('exportSettings.headerFooter.headerCenter')"
          ...
          <text-box
            v-if="headerType === 2"
            :description="$t('exportSettings.headerFooter.headerRight')"
          ...
          <text-box
            v-if="footerType === 2"
            :description="$t('exportSettings.headerFooter.footerLeft')"
          ...
          <text-box
            v-if="footerType !== 0"
            :description="$t('exportSettings.headerFooter.footerCenter')"
          ...
          <text-box
            v-if="footerType === 2"
            :description="$t('exportSettings.headerFooter.footerRight')"
        ...
        <el-tab-pane :label="$t('exportSettings.tabs.toc')" name="toc">
          <bool
            :description="$t('exportSettings.toc.includeTopHeading')"
            :detailedDescription="$t('exportSettings.toc.includeTopHeadingDetail')"
...
export default {
  ...
  computed: {
    ...
    localizedPageSizeList () {
      return this.pageSizeList.map(item => ({
        value: item.value,
        label: item.label.startsWith('exportSettings.') ? this.$t(item.label) : item.label
      }))
    },
    localizedHeaderFooterTypes () {
      return this.headerFooterTypes.map(item => ({
        value: item.value,
